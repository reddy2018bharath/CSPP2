...
public class List<E> {
    ...
    /**
     * function to add all the given items into the list.
     *
     ...
     */
    /**
     * function to remove the item which is in the given index.
     *
     ...
     */
    /**
     * function to get the item in the given index.
     *
     * @param      index  The index
     *
     ...
     */
    /**
     * Function to know an item is present or not in the list.
     *
     * @param      item  The item
     *
    ...
    /*Returns a boolean value if the given list is equal to the 
     * present list or not.
     */
      /**
